goog.provide('zb.ui.widgets.BaseListDataList');
goog.require('zb.ui.data.CyclicalList');
...
/**
 */
zb.ui.widgets.BaseListDataList = class extends zb.ui.widgets.AbstractBaseListBuffer {
	/**
	 * @override
	 */
	 ...
	 */
	isDynamic() {
		return this._source instanceof zb.ui.data.DynamicList;
	}
	 ...
	 */
	isCyclical() {
		return this._source instanceof zb.ui.data.CyclicalList;
	}
	 ...
	 */
	isGlobalStart() {
		return this.isDynamic() ? /** @type {zb.ui.data.DynamicList} */(this._source).isStartReached() : true;
	}
	 ...
	 */
	isGlobalEnd() {
		return this.isDynamic() ? /** @type {zb.ui.data.DynamicList} */(this._source).isEndReached() : true;
	}
	...
	_onItemsAddedRemoved() {
		// Если это zb.ui.data.DynamicList, то данные не добавляются и не удаляются из произвольного места.
