goog.provide('zb.ui.widgets.ScrollBar');
...
/**
 */
zb.ui.widgets.ScrollBar = class extends zb.widgets.InlineWidget {
	/**
	 * @param {HTMLElement=} opt_container
	 * @param {zb.ui.widgets.ScrollBar.Input=} opt_params
	 */
	constructor(opt_container, opt_params) {
		...
		const createStructure = () => {
			...
			thumb = zb.html.div('w-zbui-scroll-bar__thumb');
		...
		if (typeof opt_container === 'undefined') {
			...
			createStructure();
			params = /** @type {zb.ui.widgets.ScrollBar.Input} */ (opt_container);
		}
 ...
 * @protected
 */
zb.ui.widgets.ScrollBar.prototype._isVertical;
 ...
 * @protected
 */
zb.ui.widgets.ScrollBar.prototype._containerSize;
 ...
 * @protected
 */
zb.ui.widgets.ScrollBar.prototype._thumb;
 ...
 * @protected
 */
zb.ui.widgets.ScrollBar.prototype._thumbSize;
 ...
 * @protected
 */
zb.ui.widgets.ScrollBar.prototype._minThumbSize;
