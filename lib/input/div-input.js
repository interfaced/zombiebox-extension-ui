...
goog.require('zb.ui.templates.divInput.DivInputOut');
goog.require('zb.ui.templates.divInput.divInput');
...
zb.ui.DivInput = class extends zb.ui.AbstractInput {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.divInput.divInput({});
	}
...
/**
 * @type {zb.ui.templates.divInput.DivInputOut}
 * @protected
 */
