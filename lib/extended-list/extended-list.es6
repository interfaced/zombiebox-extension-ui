...
goog.require('zb.ui.templates.extendedList');
...
zb.ui.ExtendedList = class extends zb.ui.BaseList {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.extendedList(this._getTemplateData(), this._getTemplateOptions());
	}
...
/**
 * @type {zb.ui.templates.ExtendedListOut}
 * @protected
 */
