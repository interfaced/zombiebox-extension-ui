...
goog.require('zb.ui.templates.helpBar.HelpBarOut');
goog.require('zb.ui.templates.helpBar.helpBar');
...
zb.ui.HelpBar = class extends zb.widgets.CuteWidget {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.helpBar.helpBar(this._getTemplateData(), this._getTemplateOptions());
	}
...
/**
 * @type {zb.ui.templates.helpBar.HelpBarOut}
 * @protected
 */
