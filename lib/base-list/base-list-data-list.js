...
zb.ui.BaseListDataList = class extends zb.ui.BaseListBuffer {
	/**
	 * @override
	 */
	 ...
	 */
	isGlobalStart() {
		return this.isDynamic() ? /** @type {zb.ui.DynamicList} */(this._source).isStartReached() : true;
	}
	 ...
	 */
	isGlobalEnd() {
		return this.isDynamic() ? /** @type {zb.ui.DynamicList} */(this._source).isEndReached() : true;
	}
