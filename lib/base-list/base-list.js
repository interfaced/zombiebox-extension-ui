...
goog.require('zb.ui.templates.baseList.BaseListOut');
goog.require('zb.ui.templates.baseList.baseList');
...
zb.ui.BaseList = class extends zb.widgets.CuteWidget {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.baseList.baseList(this._getTemplateData(), this._getTemplateOptions());
	}
...
/**
 * @type {zb.ui.templates.baseList.BaseListOut}
 * @protected
 */
