...
goog.require('zb.ui.templates.scrollList.ScrollListOut');
goog.require('zb.ui.templates.scrollList.scrollList');
...
zb.ui.ScrollList = class extends zb.ui.BaseList {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.scrollList.scrollList(this._getTemplateData(), this._getTemplateOptions());
	}
...
/**
 * @type {zb.ui.templates.scrollList.ScrollListOut}
 * @protected
 */
