...
goog.require('zb.ui.templates.playerProgress.PlayerProgressOut');
goog.require('zb.ui.templates.playerProgress.playerProgress');
goog.require('zb.widgets.CuteWidget');


zb.ui.PlayerProgress = class extends zb.widgets.CuteWidget {
	/**
	 * @override
	 */
	constructor() {
	 ...
	 * @protected
	 */
	_onTimeUpdate(eventName, currentTime) {
		this._updateProgress();
	}
