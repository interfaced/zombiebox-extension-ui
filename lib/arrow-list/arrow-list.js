...
goog.require('zb.ui.templates.arrowList.ArrowListOut');
goog.require('zb.ui.templates.arrowList.arrowList');
...
zb.ui.ArrowList = class extends zb.ui.BaseList {
	 ...
	 */
	_renderTemplate() {
		return zb.ui.templates.arrowList.arrowList(this._getTemplateData(), this._getTemplateOptions());
	}
...
/**
 * @type {zb.ui.templates.arrowList.ArrowListOut}
 * @protected
 */
