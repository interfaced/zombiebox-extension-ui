 ...
 * @constructor
 */
zb.ui.Throbber = function(opt_container, opt_params) {
	...
	var stepInterval = (opt_params && opt_params.stepInterval) || this.STEP_INTERVAL;
	this._timer = new zb.Timeout(this._update.bind(this), stepInterval);

	this._setPosition(0);
};
goog.inherits(zb.ui.Throbber, zb.widgets.InlineWidget);


/**
 * @param {IThenable} promise
 */
zb.ui.Throbber.prototype.wait = function(promise) {
 ...
 * @protected
 */
zb.ui.Throbber.prototype._start = function() {
 ...
 * @protected
 */
zb.ui.Throbber.prototype._stop = function() {
	this._timer.stop();
 ...
 * @protected
 */
zb.ui.Throbber.prototype._update = function() {
 ...
 * @protected
 */
zb.ui.Throbber.prototype._setPosition = function(position) {
