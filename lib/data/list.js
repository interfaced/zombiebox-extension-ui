...
/**
 * @template ItemType
 * @implements {zb.ui.data.IList}
 */
zb.ui.data.List = class extends zb.events.EventPublisher {
	/**
	 ...
	 */
	preload() {
		return /** @type {IThenable<zb.ui.data.IList>} */ (Promise.resolve(this));
	}
 ...
 * @protected
 */
zb.ui.data.List.prototype._items;
 ...
 * @protected
 */
zb.ui.data.List.prototype._currentIndex;
 ...
 * @protected
 */
zb.ui.data.List.prototype._autoSelect;
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEM_SELECTED = 'item-selected';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_CLEAR = 'clear';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_FIRST_ITEM_ADDED = 'first-item-added';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEM_ADDED = 'item-added';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEMS_ADDED = 'items-added';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEM_REMOVED = 'item-removed';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEMS_REMOVED = 'items-removed';
 ...
 * @const {string}
 */
zb.ui.data.List.prototype.EVENT_ITEMS_CHANGED = 'items-changed';
